 ...
 */
public final class MatSizeRow extends MatPrefixFunction {
    private final static String HELP = "... [mat] returns the number of rows of given matrix mat.";
    ...
    public MatSizeRow() {
        super("SizeRow", (byte) -1, DOMAIN, false, HELP, EXAMPLE, RESULT);
    }

    @Override
    public ListIntervals __compute(ListIntervals input) throws Exception {
        return new ListIntervals ( new IntervalPoint (input.rowSize()));
    }
