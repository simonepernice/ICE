 ...
 */
public final class MatEigenValue extends MatPrefixFunction {
    private final static String HELP = "... [mat] returns the eigen value matrix of the given square matrix mat.\nUses JAMA library.";
    ...
    public MatEigenValue() {
        super("EigenValue", (byte) -1, DOMAIN, false, HELP, EXAMPLE, RESULT);
    }

    @Override
    public ListIntervals __compute(ListIntervals input) throws Exception {
        try {
            return MatConversion.Array2IntervalList(new Matrix(MatConversion.IntervalList2Array(input)).eig().getD().getArray());
        } catch (Exception e) {
