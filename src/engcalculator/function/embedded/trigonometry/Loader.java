...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new TriSin());
        AddPrefixFunction (new TriCos());
        AddPrefixFunction (new TriTan());
        AddPrefixFunction (new TriArcCos());
        AddPrefixFunction (new TriArcSin());
        AddPrefixFunction (new TriArcTan());
        AddVariableFunction (new TriPI());
    }        
