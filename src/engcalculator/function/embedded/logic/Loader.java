...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new LgcNot());
        AddInfixFunction (new LgcOr(), "or");  
        AddInfixFunction (new LgcAnd(), "and");
        AddInfixFunction (new LgcXor(), "and");
        AddVariableFunction (new LgcTrue());
        AddVariableFunction (new LgcFalse());
        AddVariableFunction (new LgcTrueFalse());                              
    }        
