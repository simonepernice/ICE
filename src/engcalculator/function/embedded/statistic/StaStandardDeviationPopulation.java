 ...
 */
public final class StaStandardDeviationPopulation extends FunctionPrefix {
    ...
    private final static String[] RESULT = {"0","sqrt(1/4)"};

    public StaStandardDeviationPopulation() {
        super("statistic", "StandardDeviationPopulation", (byte) -1, DOMAIN, false, true, HELP, EXAMPLE, RESULT);
    }

    @Override
    public ListIntervals _compute(ListIntervals input) throws Exception {
        return SQRT._compute(AVERAGE._compute(SQR.compute(SUB.compute(AVERAGE.compute(input), input))));
    }
}
