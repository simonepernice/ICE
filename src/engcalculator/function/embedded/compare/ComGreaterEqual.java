 ...
 */
public final class ComGreaterEqual extends ComInfixFunction {
private final static String HELP = "a ... b check if a >= b.\nIt checks if for every points of the first interval exists a greater or equal point in the second and returns true, if some it return trueFalse, if none it returns false.";
