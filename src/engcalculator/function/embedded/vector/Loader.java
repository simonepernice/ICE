...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddInfixFunction (new VecProductScalar(), "times");
        AddInfixFunction (new VecProductVector(), "times");
        AddPrefixFunction (new VecModule());
        AddPrefixFunction (new VecDivergence());
        AddPrefixFunction (new VecGradient());
        AddPrefixFunction (new VecCurl());                        
    }        
