 ...
 */
public abstract class VecPrefixFunction extends FunctionPrefix {
    private final DomainList domain;

	private final static String HELP = " This function can be also applied to a set of sublist of ({vector1}, {vector2}, ..)";

    public VecPrefixFunction(String name, byte args, DomainList domain, boolean expandToList, String help, String[] examples, String[] results) {
