...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
       AddPrefixFunction (new EngPreferredValue());
       AddPrefixFunction (new EngPreferredValueCloser());
       AddPrefixFunction (new EngPreferredValueList());
       AddPrefixFunction (new EngPreferredValueScannerCloser());
       AddPrefixFunction (new EngPreferredValueScannerLowest());
       AddPrefixFunction (new EngToColorCode());
       AddPrefixFunction (new EngFromColorCode());
       AddPrefixFunction (new EngPartition());
       AddPrefixFunction (new EngPartitionInverse());
       AddPrefixFunction (new EngSPTau());
       AddInfixFunction (new EngSumInverted(), "times");
       AddInfixFunction (new EngSumSquared(), "times");                        
    }        
