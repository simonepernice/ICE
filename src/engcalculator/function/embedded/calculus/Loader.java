...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new CalDerivate ());
        AddPrefixFunction (new CalJacobian ());
        AddPrefixFunction (new CalIntegrateUniform());
        AddPrefixFunction (new CalIntegrateAdaptive());
        AddPrefixFunction (new CalIntegrateUniformFunction());   
        AddPrefixFunction (new CalSeriesSum());   
        AddPrefixFunction (new CalSeriesProduct());   
        AddPrefixFunction (new CalFuncFindAbsolute());   
        AddPrefixFunction (new CalFuncFindRelative());   
        AddPrefixFunction (new CalFuncFindMatch());   
