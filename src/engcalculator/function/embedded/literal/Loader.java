...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new LitRegExMatch());            
        AddPrefixFunction (new LitRegExSplit());            
        AddPrefixFunction (new LitRegExFind());            
        AddPrefixFunction (new LitCharJoin());            
        AddPrefixFunction (new LitCharSplit());            
        AddPrefixFunction (new LitToUnicode());            
        AddPrefixFunction (new LitFromUnicode());            
        AddPrefixFunction (new LitToExpression());            
        AddPrefixFunction (new LitFromExpression());            
        AddPrefixFunction (new LitFromInterval());                                    
        AddPrefixFunction (new LitFromIntervalDetailed());                                    
    }        
