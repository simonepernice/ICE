 ...
 */
public final class LitFromUnicode extends FunctionPrefix {
    ...
    private final static String HELP = "... (unicode1, unicode2, .. unicodeN) returns the characters with the given unicode number.";
    private final static String[] EXAMPLE = {"literalToUnicode('home')"};
    private final static String[] RESULT = {"'home'"};

    public LitFromUnicode() {        
        super("literal", "FromUnicode", (byte) -1, DOMAIN, false, true, HELP, EXAMPLE, RESULT);
    }
    ...
    public ListIntervals _compute(ListIntervals input) throws Exception {
        ...
        for (int i=0;i<s;++i)
            result.append(Character.toChars((int) input.get(i).getValue()));
