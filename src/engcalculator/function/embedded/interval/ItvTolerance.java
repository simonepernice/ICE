 ...
 */
public final class ItvTolerance extends FunctionPrefixSingleInputSingleOutput {
    private final static String HELP = "... (a%b) returns b.\nIt computes the tolerance on every interval of a list of intervals.";
    private final static String[] EXAMPLE = {"1%10, 5.10%2"};
    private final static String[] RESULT = {"10, 2"};
    private final static DomainList DOMAIN = new DomainList (new DomainIntervalReal());

    public ItvTolerance() {
        super ("interval", "Tolerance", DOMAIN, true, true, HELP, EXAMPLE, RESULT);
    }

    @Override
    public Interval _computeIntervals (Interval input) throws Exception {
        return new IntervalPoint(input.getTolerance());
    }
