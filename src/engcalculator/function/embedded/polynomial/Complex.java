...
* @param re The real part.
    ...
    /**
     * Returns the real part. Verifies that <code>abs(im) &lt;= eps</code> or
     * <code>abs(im) &lt;= eps * abs(re)</code>.
     */
...
//--- Unary operations ---------------------------------------------------------
    ...
    /**
     * Returns the exponential function. (The Euler's number e raised to the
...
//--- Binary operations --------------------------------------------------------
    ...
    /**
     * Returns <code>true</code> if the real and imaginary parts of the two
     * numbers do not differ more than <code>eps</code>.
     */
