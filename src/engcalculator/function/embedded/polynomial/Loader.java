...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {    
        AddPrefixFunction(new PlyEvaluate());
        AddPrefixFunction(new PlySolveDK());
        AddPrefixFunction(new PlySolveNR());
        AddPrefixFunction(new PlySolveL());
        AddPrefixFunction(new PlySolveJT());
        AddPrefixFunction(new PlyTaylor());
        AddInfixFunction(new PlyMul(), "times");
        AddInfixFunction(new PlyDiv(), "times");
        AddInfixFunction(new PlySum(), "sum");
        AddInfixFunction(new PlySub(), "sum");
        AddPrefixFunction(new PlyDerivate());
        AddPrefixFunction(new PlyIntegrate());
    }        
