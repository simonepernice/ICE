...
public final class PlySub extends FunctionInfix {
    ...
    public ListIntervals _compute(ListIntervals leftSide, ListIntervals rightSide) throws Exception {
        ...
        ListIntervals result =  SUB.compute(ls, rs);  
