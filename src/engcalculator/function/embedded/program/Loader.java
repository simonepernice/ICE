...
import engcalculator.function.embedded.decibel.*;
...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new ProType());
        AddPrefixFunction (new ProArgumentSize());
        AddPrefixFunction (new ProError());
        AddPrefixFunction (new ProTimeMs());
        AddPrefixFunction (new ProCallFunction());                      
        AddPrefixFunction (new ProOnErrorReturn());                                             
    }        
