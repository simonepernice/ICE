...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddInfixFunction (new AriSum(), "sum");
        AddInfixFunction (new AriSub(), "sum");   
        AddInfixFunction (new AriMul(), "times");
        AddInfixFunction (new AriDiv(), "times");
        AddPrefixFunction (new AriDoNothing());
        AddPrefixFunction (new AriNegate());
        AddPrefixFunction (new AriInvert());        
    }        
