...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new SLsExtract());
        AddPrefixFunction (new SLsSort());
        AddInfixFunction (new SLsUnion(), "union");
        AddInfixFunction (new SLsIntersection(), "intersection");
        AddInfixFunction (new SLsDifference(), "intersection");			                         
    }        
