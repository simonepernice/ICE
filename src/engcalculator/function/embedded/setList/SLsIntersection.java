 ...
 */
public final class SLsIntersection extends FunctionInfix {
    private final static String HELP = "(listA) ... (listB) returns the intersection of the given setlist.\nThe intersection is made by the common elements without duplicates.";
    private final static String[] EXAMPLE_LEFT = {"1, 2, 3, 4, 4, 5, 6"};
    private final static String[] EXAMPLE_RIGHT = {"4, 5, 6, 7, 8"};
    private final static String[] RESULT = {"4, 5, 6"};
    ...
    public ListIntervals _compute(ListIntervals left, ListIntervals right) throws Exception {
        final int sl = left.size();
        final int sr = right.size();
