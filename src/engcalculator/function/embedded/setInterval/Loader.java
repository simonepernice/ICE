...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddInfixFunction (new SInSub(), "compare");
        AddInfixFunction (new SInSuper(), "compare"); 
        AddInfixFunction (new SInUnion(), "union");
        AddInfixFunction (new SInIntersection(), "intersection");                            
    }        
