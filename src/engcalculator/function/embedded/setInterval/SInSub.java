 ...
 */
public final class SInSub extends ComInfixFunction {
    private final static String HELP = "intervalA ... intervalB checks if an intervalA is a subset of intervalB  returning 0 for false, 1 for true.\nSubset means every element of the firs interval is available in the second (the opposite is not required).";
    private final static String[] EXAMPLE_LEFT = {"6_7","6_7", "1_2", "3_4"};
    private final static String[] EXAMPLE_RIGHT = {"5_8","7_8", "1.5_3", "-3_-2"};
    private final static String[] RESULT = {"1","0_1","0_1","0"};
