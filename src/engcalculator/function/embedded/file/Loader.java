...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new FilSaveList());
        AddPrefixFunction (new FilLoadList());
        AddPrefixFunction (new FilLoadPointMatrix());
        AddPrefixFunction (new FilLoadCSVPointMatrix());
        AddPrefixFunction (new FilSaveCSVPointMatrix());    
