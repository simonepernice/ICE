...
public final class FilLoadList extends FunctionPrefix {
    ...
    public FilLoadList() {
        super("file", "LoadList", (byte) 1, DOMAIN, false, true, HELP, EXAMPLE, RESULT);
    }
    ...
    public ListIntervals _compute(ListIntervals input) throws Exception {
        ...
        try {
            ...
            throwNewCalculusException ("It was not possible to load the file: "+e.getMessage());
