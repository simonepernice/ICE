 ...
 */
public final class IntXor extends IntInfixFunction {
    private final static String HELP = "a ... b computes the XOR operation bit by bit between two integer point intervals a and b.";
    ...
    private final static String[] RESULT = {"integerFromBaseToBaseTen(2, '0110')"};
