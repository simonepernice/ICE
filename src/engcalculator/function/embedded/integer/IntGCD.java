 ...
 */
public final class IntGCD extends FunctionPrefix {
    private final static String HELP = "... (a, b) returns the greatest commond divisor between a and b.\nSee also lcm.";
    ...
    public IntGCD() {
        super("integer", "GCD", (byte) 2, DOMAIN, true, true, HELP, EXAMPLE , RESULT);
    }
    
    @Override
    public ListIntervals _compute (ListIntervals input) throws Exception {
        long a = (long) input.getFirst().getValue(), b = (long) input.get(1).getValue();
        return new ListIntervals(new IntervalPoint(gcd(a, b)));
    }
