...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new IntRoundToDigit());
        AddPrefixFunction (new IntFloor());
        AddPrefixFunction (new IntRound());
        AddPrefixFunction (new IntCeiling());
        AddPrefixFunction (new IntFactorization());
        AddPrefixFunction (new IntGCD());
        AddPrefixFunction (new IntLCM());
        AddPrefixFunction (new IntFromBaseToBaseTen());
        AddPrefixFunction (new IntBaseTenToBase());
        AddPrefixFunction (new IntFactorial());
        AddInfixFunction (new IntOr(), "or");
        AddInfixFunction (new IntAnd(), "and");
        AddInfixFunction (new IntXor(), "and");
        AddPrefixFunction (new IntNot());
        AddInfixFunction (new IntDiv(), "times");
        AddInfixFunction (new IntModule(), "times");                        
    }        
