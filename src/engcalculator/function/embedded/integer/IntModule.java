 ...
 */
public final class IntModule extends IntInfixFunction {
    private final static String HELP = "a ... b compute the integer module between two integer point intervals a and b.";
