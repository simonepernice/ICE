...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new HypSin());
        AddPrefixFunction (new HypCos());
        AddPrefixFunction (new HypTan());
        AddPrefixFunction (new HypArcSin());
        AddPrefixFunction (new HypArcCos());
        AddPrefixFunction (new HypArcTan());                        
    }        
