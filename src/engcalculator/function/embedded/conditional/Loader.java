...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new CndIf());                          
        AddPrefixFunction (new CndIfTrue());                          
        AddPrefixFunction (new CndSwitch());                          
        AddPrefixFunction (new CndWhile());                          
        AddPrefixFunction (new CndDoWhile());                          
        AddPrefixFunction (new CndFor());                          
    }        
