...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new PltData());
        AddPrefixFunction (new PltStandard());
        AddPrefixFunction (new PltStandardLogarithmic());
        AddPrefixFunction (new PltStandardAdaptive());
        AddPrefixFunction (new PltStandardTick());
        AddPrefixFunction (new PltParametric());
        AddPrefixFunction (new PltParametricTick());
        AddPrefixFunction (new PltSurface());
        AddPrefixFunction (new PltVector());
        AddPrefixFunction (new PltBodeModule());
        AddPrefixFunction (new PltBodePhase());
        AddVariableFunction(new PltFunctionByMouseClick());                        
    }        
