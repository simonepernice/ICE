...
public final class EquFindIntersection extends EquBisectionMethod {
    private final static String HELP = "... ($f1, $f2, interval1, ..) finds the intersection between a couple of 'thick' functions f1 and f2 in the given intervals: interval1, interval2, .. .\nIt needs the function names and then the initial intervals containing the intersection. That interval will be shrunken to the smallest containing the intersection. It is used bisection method. If the function returns multiple variables only the first element will be used to find the intersection.";
    ...
    public EquFindIntersection() {
        super ("equation", "FindIntersection", (byte) 3, DOMAIN, false, true, HELP, EXAMPLE, RESULT);
    }
