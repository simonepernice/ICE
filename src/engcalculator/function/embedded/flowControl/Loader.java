...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new FlcRepeatThisWhile());
        AddPrefixFunction (new FlcRepeatNextWhile());
        AddPrefixFunction (new FlcRepeatPreviousWhile());
        AddPrefixFunction (new FlcSkipNextIf());
        AddPrefixFunction (new FlcReturnThisIf());
        AddPrefixFunction (new FlcStopHereIf());                             
    }        
