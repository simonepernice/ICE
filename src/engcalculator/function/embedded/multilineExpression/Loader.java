...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddVariableFunction(new MleStatement());
        AddPrefixFunction(new MleGetResult());
        AddPrefixFunction(new MleGoTo());
        AddPrefixFunction(new MleGoSub());
        AddPrefixFunction(new MleGoToEnd());
        AddVariableFunction(new MleGoToBegin());
        AddVariableFunction(new MleReturn());
        AddVariableFunction(new MleGoToPrevious());
        AddVariableFunction(new MleGoToBeforePrevious());
        AddVariableFunction(new MleGoToThis());
        AddVariableFunction(new MleGoToAfterNext());
    }        
