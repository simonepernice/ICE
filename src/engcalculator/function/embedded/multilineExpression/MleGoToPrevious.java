 ...
 */
public final class MleGoToPrevious extends FunctionVariableMultilineExpression {
    private final static String HELP = "... go to the previous expression line.\n";    
    ...
    public MleGoToPrevious () {
        super ("GoToPrevious", WorkFlowExpression.GOTO_PREV_EX, HELP, EXAMPLES, RESULTS);
    }
