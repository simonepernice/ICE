...
public class Loader extends GroupLoader {
    ...
    public void loadGroupFunctions() throws Exception {
        AddPrefixFunction (new SysQuit());
        AddPrefixFunction (new SysSetupSetParameter());
        AddPrefixFunction (new SysSetupGetParameter());
        AddPrefixFunction (new SysUseGroup());     
        AddPrefixFunction (new SysAnswerGet());                         
    }        
